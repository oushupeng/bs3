                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr  id="tab">
                                        ...
                                        <td scope="row">
                                            <?= Html::textInput('shopCart[pets_name]',$model->pets_name,['class' => 'details', 'onfocus'=>'this.blur()' ])?>
                                        </td>

                                        <td scope="row">
                                            <?= Html::textInput('shopCart[pets_price]',$model->pets_price,['class' => 'details price', 'onfocus'=>'this.blur()'])?>
                                        </td>


                                        <td scope="row">
                                            <?php  $form = ActiveForm::begin(['action' => ['/shop-cart/update', 'id' => $model->id],'method' => 'post'])?>

                                            <div class="gw_num">
                                                <em class="min">
                                                    <?= Html::submitButton('-', ['class' => 'min']) ?>
                                                </em>
                                                <?= Html::textInput('ShopCart[pets_num]',$model->pets_num,['class' => 'num'])?>
                                                <em class="add">
                                                    <?= Html::submitButton('+', ['class' => 'add']) ?>
                                                </em>
                                            </div>

<!--                                            <span>单价:</span><span class="price">--><?//= $model->pets_price?><!--</span>-->
...
<!--                                            <p>总价：<label id="total"></label></p>-->
                                        ...
                                        <td>
                                            <?= Html::textInput('Orders[amount]',$model->pets_price * $model->pets_num,['class' => 'details total ', 'onfocus'=>'this.blur()'])?>
                                        </td>
...
<!--                                    --><?//= Html::textInput('shopCart[pets_name]',$model->pets_name,['class' => 'details hidden', 'onfocus'=>'this.blur()' ])?>
                                    ...
                                    <?= Html::textInput('OrdersDetails[pets_id]',$model->pets_id,['class' => 'details price hidden', 'onfocus'=>'this.blur()'])?>
                                    <?= Html::textInput('OrdersDetails[pets_price]',$model->pets_price,['class' => 'details price hidden', 'onfocus'=>'this.blur()'])?>
                                    <?= Html::textInput('OrdersDetails[pets_num]',$model->pets_num,['class' => 'details price hidden', 'onfocus'=>'this.blur()'])?>

                                    <?= Html::textInput('Orders[amount]',$model->pets_price * $model->pets_num,['class hidden' => 'details total ', 'onfocus'=>'this.blur()'])?>
