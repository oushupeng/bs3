        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="" id="num" class="form-control" value="<?= $model->amount?>"
                               onfocus='this.blur()'>
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputAddress2"
                                       placeholder="Apartment, studio, or floor" value="<?= $model->consignee ?>"
                                       onfocus='this.blur()'>
                            </div>
                            <div class="form-group">
                                <label for="inputAddress2">电话号码</label>
                                <input type="text" class="form-control" id="inputAddress2"
                                       placeholder="Apartment, studio, or floor" value="<?= $model->telephone ?>"
                                       onfocus='this.blur()'>
                            </div>
                            <div class="form-group">
                                <label for="inputAddress2">收货地址</label>
                                <input type="text" class="form-control" id="inputAddress2"
                                       placeholder="Apartment, studio, or floor" value="<?= $model->address ?>"
                                       onfocus='this.blur()'>
                            </div>
                            <div class="form-group">
                                <label for="inputAddress2">备注</label>
                                <input type="text" class="form-control" id="inputAddress2"
                                       placeholder="无" value="<?= $model->remarks ?>"
                                       onfocus='this.blur()'>
                            </div>
                            <div class="form-group">
